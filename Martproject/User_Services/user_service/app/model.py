...
from typing import Optional,AsyncGenerator,Optional
...
class New_User(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)  # Primary key defined here
    username: str  # Username field for authentication
    password: str  # Password field for authentication
    email: str  # Email field with correct type
